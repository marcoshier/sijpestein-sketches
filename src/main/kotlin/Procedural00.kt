    ...
    oliveProgram {
        ...
        val ss = shadeStyle {
            ...
            fragmentTransform = """
                ...
                vec2 sunPos = p_mousePos.xy / c_boundsSize.xy;
                float U1 = sunPos.x;
                float V1 = 1.0 - sunPos.y;
                
                float r = kAtmRadiusMin + 0.1;
                float cosH = AtmHorizonCos(r) - 0.1;
                
                vec3 VDir = UVToEquirectCoord(U, V, 0.0);
        ...
        extend {
            ...
            ss.parameter("mousePos", mouse.position)
